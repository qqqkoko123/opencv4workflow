...
"border:none;"));
        ...
        comboTriggerMode->setMinimumSize(QSize(80, 30));
...
"border:none;"));
        ...
        comboCamera->setMinimumSize(QSize(92, 33));
...
"QPushButton:pressed{background-color: rgb(29, 82, 72);}"));
    ...
    void retranslateUi(QDialog *frmCameraSetUpClass)
    {
        ...
        comboCamera->setItemText(2, QCoreApplication::translate("frmCameraSetUpClass", "USBCamera", nullptr));
